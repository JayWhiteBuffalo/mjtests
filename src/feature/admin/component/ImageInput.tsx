...
const Item = ({publicId, selected, onDelete, ...rest}) => (
  <li className="relative flex-none group">
    <button
      ...
      {...rest}
    >
      <FixedHeightImage alt="Uploaded image" height={240} publicId={publicId} />
    </button>
    <button
...
export const ImageDropzone = ({onDrop, ...rest}) => (
  ...
  >
    ...
    <div>
      <p className="text-lg">Drag images here, or click to select</p>
      <p className="text-sm text-neutral-400">
        Supported formats: .png / .gif / .jpeg / .webp / .avif / .heic
      </p>
      <p className="text-sm text-neutral-400">Max 10mb</p>
    </div>
  </Dropzone>
)
