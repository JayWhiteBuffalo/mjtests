    ...
    <FormProvider {...methods}>
      <form className="AdminForm" action={handleSubmit(action)}>
        ...
        <section>
          ...
          >
            <Input {...register('contact.tel')} autoComplete="tel" />
          </FieldLayout>
          ...
          <FieldLayout error={errors.contact?.url} label="Website (Optional)">
            <Input {...register('contact.url')} autoComplete="url" />
          </FieldLayout>
          ...
          >
            <Input {...register('contact.twitter')} autoComplete="twitter" />
          </FieldLayout>
          ...
          >
            <Input {...register('contact.facebook')} autoComplete="facebook" />
          </FieldLayout>
          ...
          <Controller
            ...
            render={({field, fieldState}) => (
              <RadioGroup
                ...
                value={field.value}
              >
                <Radio description="Store is in business." value="open">
                  Open
                </Radio>
                <Radio
        ...
        <section>
          ...
          <FieldLayout error={errors.license?.state} label="State of operation">
            <Input
          ...
          <FieldLayout
            ...
            description={
              <span>
                The dispensary license is issued by the Oklahoma Medical
                Marijuana Authority (OMMA). The license number is 12 character
                alphanumeric code, e.g. <code>DAAA-1234-5XYZ</code>.
              </span>
            }
          >
            <FormattedInput
        ...
        <section className="hidden">
          ...
          <FieldLayout
            ...
            description={
              <span>
                The slug represents this dispensary in URLs. For example{' '}
                <code>
                  http://treemap.com/vendor/<strong>acme-joint-emporium</strong>
                </code>
                .
              </span>
            }
          >
            <Input {...register('slug')} autoComplete="vendor-slug" />
          </FieldLayout>
        </section>
