    ...
    <FormProvider {...methods}>
      <form className="AdminForm" action={handleSubmit(action)}>
        <section>
          ...
          <FieldLayout label="Your Name" error={errors.user?.name}>
            <Input
              {...register('user.name')}
        ...
        <section>
          ...
          <FieldLayout
            ...
            description={
              <span>
                This is the name of your dispensary, for example{' '}
                <i>Acme Joint Emporium.</i>
              </span>
            }
            label="Name of dispensary"
          >
            <Input {...register('vendor.name')} autoComplete="organization" />
          </FieldLayout>
          ...
          <FieldLayout error={errors.vendor?.url} label="Website (Optional)">
            <Input {...register('vendor.url')} autoComplete="url" />
          </FieldLayout>
          ...
          <FieldLayout
            ...
            description={
              <span>
                Your dispensary&apos;s public, general contact phone number.
              </span>
            }
            label="Phone (Optional)"
          >
            <Input {...register('vendor.tel')} autoComplete="tel" />
          </FieldLayout>
        ...
        <input {...register('type')} type="hidden" name="type" value="vendor" />
